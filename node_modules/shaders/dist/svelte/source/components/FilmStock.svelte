<script lang="ts">
    ...
    import { componentDefinition, type ComponentProps } from '../../../core/shaders/FilmStock/index.js';
    ...
    interface ExtendedComponentProps extends Partial<ComponentProps> {
        ...
        halation?: ComponentProps['halation'] | PropDriver;
        weave?: ComponentProps['weave'] | PropDriver;
        blendMode?: BlendMode;
        opacity?: number;
        visible?: boolean;
        id?: string;

<script lang="ts">
    ...
    import { componentDefinition, type ComponentProps } from '../../../core/shaders/Form3D/index.js';
    ...
    interface ExtendedComponentProps extends Partial<ComponentProps> {
        ...
        glossiness?: ComponentProps['glossiness'] | PropDriver;
        lighting?: ComponentProps['lighting'] | PropDriver;
        blendMode?: BlendMode;
        opacity?: number;
        visible?: boolean;
        id?: string;

<script lang="ts">
    ...
    import { componentDefinition, type ComponentProps } from '../../../core/shaders/Heatmap/index.js';
    ...
    interface ExtendedComponentProps extends Partial<ComponentProps> {
        ...
        innerGlow?: ComponentProps['innerGlow'] | PropDriver;
        outerGlow?: ComponentProps['outerGlow'] | PropDriver;
        contour?: ComponentProps['contour'] | PropDriver;
        blendMode?: BlendMode;
        opacity?: number;
        visible?: boolean;
        id?: string;

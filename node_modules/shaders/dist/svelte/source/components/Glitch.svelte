<script lang="ts">
    ...
    import { componentDefinition, type ComponentProps } from '../../../core/shaders/Glitch/index.js';
    ...
    interface ExtendedComponentProps extends Partial<ComponentProps> {
        ...
        rgbShift?: ComponentProps['rgbShift'] | PropDriver;
        blockDensity?: ComponentProps['blockDensity'] | PropDriver;
        colorBarIntensity?: ComponentProps['colorBarIntensity'] | PropDriver;
        mirrorAmount?: ComponentProps['mirrorAmount'] | PropDriver;
        scanlineIntensity?: ComponentProps['scanlineIntensity'] | PropDriver;
        blendMode?: BlendMode;
        opacity?: number;
        visible?: boolean;
        id?: string;

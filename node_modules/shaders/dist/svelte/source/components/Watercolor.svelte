<script lang="ts">
    ...
    import { componentDefinition, type ComponentProps } from '../../../core/shaders/Watercolor/index.js';
    ...
    interface ExtendedComponentProps extends Partial<ComponentProps> {
        bleed?: ComponentProps['bleed'] | PropDriver;
        strength?: ComponentProps['strength'] | PropDriver;
        paper?: ComponentProps['paper'] | PropDriver;
        blendMode?: BlendMode;
        opacity?: number;
        visible?: boolean;
        id?: string;

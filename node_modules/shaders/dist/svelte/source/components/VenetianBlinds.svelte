<script lang="ts">
    ...
    import { componentDefinition, type ComponentProps } from '../../../core/shaders/VenetianBlinds/index.js';
    ...
    interface ExtendedComponentProps extends Partial<ComponentProps> {
        progress?: ComponentProps['progress'] | PropDriver;
        angle?: ComponentProps['angle'] | PropDriver;
        stripCount?: ComponentProps['stripCount'] | PropDriver;
        feather?: ComponentProps['feather'] | PropDriver;
        blendMode?: BlendMode;
        opacity?: number;
        visible?: boolean;
        id?: string;

<script lang="ts">
    ...
    import { componentDefinition, type ComponentProps } from '../../../core/shaders/FloatingParticles/index.js';
    ...
    interface ExtendedComponentProps extends Partial<ComponentProps> {
        ...
        randomness?: ComponentProps['randomness'] | PropDriver;
        twinkle?: ComponentProps['twinkle'] | PropDriver;
        blendMode?: BlendMode;
        opacity?: number;
        visible?: boolean;
        id?: string;

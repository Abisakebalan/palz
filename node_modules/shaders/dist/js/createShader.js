		...
		if (isExternalUser()) {
			...
			const checkRendering = () => {
				...
				if (renderer.getPerformanceStats().fps > 0) {
					state.telemetryCollector = startTelemetry(renderer, "3.0.445", options?.disableTelemetry || false, false);

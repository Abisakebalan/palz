import { C as ShapeMask, F as sdf_exports, Ht as call, Jt as vec4, N as ringSdf, R as strokeMaskFromSdf, Tn as d, gn as mixColorsVariants, hn as mixColorsLinear, n as tgpu } from "./coords-BkIjixe_.js";
...
const ringShape = tgpu.fn([
	...
	d.vec2f,
	d.f32
], ShapeMask)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, radius, thickness, softness, strokeThickness, strokePosition, uv, aspect) => {
	"use gpu";
	...
	return strokeMaskFromSdf(ringSdf(__tsover_sub(aspectUV.x, centerPos.x), __tsover_sub(aspectUV.y, centerPos.y), radius, thickness), softness, strokeThickness, strokePosition);
}), {
	v: 1,
	name: void 0,
	ast: {
...
const componentDefinition = {
	...
	fragment: (params) => {
		...
		const mask = call(ringShape, "ringShape", [
			uniforms.center,
			uniforms.radius,
			uniforms.thickness,
			uniforms.softness,
...
export { componentDefinition as n, ringShape as r, Ring_default as t };

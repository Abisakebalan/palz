		...
		const startTelemetryWhenReady = () => {
			...
			const checkRendering = () => {
				...
				if (rendererInstance.value.getPerformanceStats().fps > 0) {
					telemetryCollector = startTelemetry(rendererInstance.value, "3.0.445", props.disableTelemetry, props.isPreview);

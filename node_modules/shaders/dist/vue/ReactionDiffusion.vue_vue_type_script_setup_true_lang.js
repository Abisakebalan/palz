...
import { componentDefinition } from "../core/shaders/ReactionDiffusion/index.js";
var _hoisted_1 = ["data-shader-id"];
var _hoisted_2 = ["width", "height"];
var ReactionDiffusion_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	__name: "ReactionDiffusion",
	...
	setup(__props) {
		...
		const shaderReadyProps = computed(() => {
			...
			for (const key in props) if (key !== "blendMode" && key !== "opacity" && key !== "visible" && key !== "id" && key !== "maskSource" && key !== "maskType" && key !== "renderOrder" && key !== "transform" && key !== "boundingBox") {
...
export { ReactionDiffusion_vue_vue_type_script_setup_true_lang_default as default };
